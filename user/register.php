...
if(isset($_POST['btn-signup']))
{
 ...
 if(mysqli_query($conn,"INSERT INTO pelanggan(nama_pelanggan,email_pelanggan,password_pelanggan,nomor_pelangan,alamat) VALUES('$uname','$email','$upass','$utel','$ualamat')"))
 {
 ...
 {
        echo "<script>alert('Anda gagal register, periksa akun anda kembali');</script>";
...
<section class="banner_bottom proj py-5">
		<div class="wrap_view">
		<h1 class="heading text-center text-uppercase mb-5"> Register Pelanggan </h1>
			<div class="inner_sec">
			...
			<center>
				<form method="post">
					<table align="center" width="30%" border="0">
						...
						<tr>
							<td><input type="email" name="email" class = "form-control" placeholder="Your Email" required /></td>
						</tr>
						<tr>
							<td><input type="password" name="pass" class = "form-control" placeholder="Your Password" required /></td>
						</tr>
						<tr>
							<td><input type="text" name="tel" class = "form-control" placeholder="Your Number Phone" required /></td>
						</tr>
						<tr>
							<td><textarea type="text" name="alamat" class = "form-control" placeholder="Your Address" required ></textarea></td>
						</tr>
						<tr>
							<td align = "center"><button type="submit" class = "btn btn-info" name="btn-signup">Sign Me Up</button></td>
						</tr>
					</table>
				</form>
			</center>
